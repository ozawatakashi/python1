...
usename = ['GrLivArea','GarageCars','TotalBsmtSF'
           ,'YearRemodAdd','YearBuilt','FullBath'
           ,'Fireplaces','BsmtFinSF1','WoodDeckSF','OpenPorchSF','LotArea','BsmtUnfSF','ScreenPorch']
...
x_train[~np.isnan(x_train).any(axis=1)] # 欠損値のある行を消す。
...
#%%
xte  = Variable(x_train, volatile='on') 
